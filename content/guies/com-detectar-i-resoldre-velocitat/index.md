---
layout: default
title: "Com detectar i resoldre problemes de velocitat d'Internet"
---

El primer pas és determinar la velocitat real de la connexió a Internet.

1. Tanca les aplicacions i atura les descàrregues que puguin consumir ample de banda.
2. Visita [speedtest.net](https://www.speedtest.net/) i escull com a servidor `Fundació Guifi.net` o `CSUC` (tal com es mostra a la següent captura):

![](images/test-velocitat.png)

3. Repeteix la prova en diferents moments del dia per comparar els resultats.

Si la velocitat de pujada o baixada és molt diferent de la velocitat contractada, revisa el següent apartat. 

## Factors que poden afectar el resultat de la prova

Hi ha diversos elements que poden influir en el mesurament del test de velocitat:
